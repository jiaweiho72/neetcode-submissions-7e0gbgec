    ...
    def combine(self, n: int, k: int) -> List[List[int]]:
        ...
        - once you choose this element j, you never choose it again
            ...
            - there won't be another exact case where the front part is the same and it choose j again, not possible
                  ...
                  /   |
                 2    1
            - don't go back to previous elements because choosing it will cause a 1,2 and 2,1
                - if select 1, let that pass handle ALL the combinations with 1
                    - other paths should not contain 1
                - branching this out, previous elements won't 
                - basically if choose current element, it will handle all combinations after it. 
                    other paths should not tou
            - go forward and not backtrack or you will reprocess your parent
        time: O(2^n) 
        space: O(2^n) stack
        10mins
        """
